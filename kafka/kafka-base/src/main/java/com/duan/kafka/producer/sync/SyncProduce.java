package com.duan.kafka.producer.sync;
import java.util.*;
...
public class SyncProduce {
	public static void main(String[] args) {
        ...
        props.put("metadata.broker.list", "duan1:9092,duan2:9092,duan3:9092");
        ...
        for (long nEvents = 0; nEvents < events; nEvents++) { 
               ...
               KeyedMessage<String, String> data = new KeyedMessage<String, String>("nongfu", ip, msg);
